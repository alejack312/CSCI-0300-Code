...
struct metadata_t {
    ...
    char dmalloc_flag;   // # sign of dmalloc allocation
    char freed_flag;     // # sign allocation was freed
};

//Think about using a global variable that holds a struct and which any calls 
//to dmalloc() and dfree(ptr) update.

extern dmalloc_stats g_statistics;
